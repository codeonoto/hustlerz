      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-[16px] sm:text-[18px] md:text-[20px] text-Blue mt-4 text-center md:text-left font-semibold leading-relaxed">
            Explore the exceptional features that make Husterz your ultimate web
            development choice.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            ...
            <div className="flex items-center space-x-4 bg-gray-800 p-4 rounded-lg">
              ...
              <p className="text-white">Seamless Content Management Systems</p>
            </div>
            <div className="flex items-center space-x-4 bg-gray-800 p-4 rounded-lg">
              <div className="bg-darkBlue text-black p-2 rounded-full">
                <span className="text-lg font-bold">3</span>
              </div>
              <p className="text-white">Interactive Web Applications Solutions</p>
            </div>
            <div className="flex items-center space-x-4 bg-gray-800 p-4 rounded-lg">
              <div className="bg-darkBlue text-black p-2 rounded-full">
    ...
    <div className="min-h-screen w-11/12 p-4 sm:p-6 md:p-10 mx-auto flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          <p className="text-[16px] sm:text-[18px] md:text-[20px] text-Blue mt-4 text-center md:text-left font-semibold leading-relaxed">
            Explore the exceptional features that make LandFree your ultimate web development choice
          </p>
