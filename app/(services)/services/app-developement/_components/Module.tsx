...
const sections: Section[] = [
  {
    ...
    description: "Our web app development services focus on creating fast, responsive, and secure web applications that offer a seamless user experience on all devices.",
    logo: <CodeXml />,
    points: [
  ...
  },
  {
    ...
    description: "We specialize in developing enterprise-grade applications that streamline operations, enhance productivity, and drive business growth.",
    logo: <Building2 />,
    points: [
  ...
  },
  {
    ...
    description: "We provide end-to-end e-commerce app development services, enabling you to deliver a seamless shopping experience to your customers.",
    logo: <ShoppingBag />,
    points: [
  ...
  },
  {
    ...
    description: "Our app maintenance services are designed to keep your app consistently updated, secure, and performing at its best, ensuring a seamless experience for your users over time.",
    logo: <Wrench />,
    points: [
          ...
          <div className="w-full lg:w-1/3 p-4">
            <ul>
              {sections.map((item) => (
                <li
                  key={item.id}
                  className={`cursor-pointer py-2 text-start transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white ${selectedSectionId === item.id ? ' text-black bg-white p-3 rounded-md font-semibold' : ''}`}
                      ...
                      <div>
                        <ul className="list-disc pl-6 text-gray-100">
                          {item.points.map((point, index) => (
                            <li key={index} className="text-gray-200 text-start">{point}</li>
                          ))}
                        </ul>
                      </div>
                    </div>
